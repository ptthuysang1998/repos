...
namespace Christoc.Modules.DNNModule1.Controllers
{
    ...
    public class SettingsController : DnnController
    {
        ...
        public ActionResult Settings()
        {
            ...
            settings.Setting1 = ModuleContext.Configuration.ModuleSettings.GetValueOrDefault("DNNModule1_Setting1", false);
            settings.Setting2 = ModuleContext.Configuration.ModuleSettings.GetValueOrDefault("DNNModule1_Setting2", System.DateTime.Now);
